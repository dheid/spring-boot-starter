...
- **Description**: The maximum duration to wait for a read operation to complete.
- **Example**: `30s`

#### `openfga.connect-timeout`

- **Description**: The maximum duration to wait for a connection to be established.
- **Example**: `10s`
...
- **Description**: The minimum delay between retry attempts.
- **Example**: `500ms`
